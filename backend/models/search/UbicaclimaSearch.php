...
/**
 * UbicaclimaSearch represents the model behind the search form about `app\models\Ubicaclima`.
 */
class UbicaclimaSearch extends Ubicaclima
{
    /**
     * @inheritdoc
     */
